...
public class PokemonTrainer {
	...
	public PokemonTrainer() throws UnknownHostException, IOException {
		 ...
		 */
                client = new Socket(InetAddress.getLocalHost(), SERVER_PORT); //oncréé un socket
                
                outputStream= new ObjectOutputStream(client.getOutputStream()); //on créé un outputstream
                inputStream= new ObjectInputStream(client.getInputStream()); //on créé un inputstream
	...
	public void sendPokemon(Pokemon pokemon) throws IOException, ClassNotFoundException {
		 ...
		 */
                ...
                outputStream.flush(); //on vide le outputstream
	...
	private void readResponse() throws ClassNotFoundException, IOException {
		 ...
		 */
                System.out.println("La réponse du serveur est la suivante :  ");
